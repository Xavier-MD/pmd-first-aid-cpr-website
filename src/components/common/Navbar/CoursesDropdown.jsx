        ...
        <>
          <Popover.Button
            className={classNames(
              ...
              'group inline-flex px-3 py-1 font-header items-center border-b-2 text-xl transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-200 delay-25'
            )}
          >
            <span>Courses</span>
            <ChevronDownIcon
              ...
              <div className='rounded-lg shadow-lg overflow-hidden'>
                <div className='pl-5 sm:px-8 sm:pt-6 w-full'>
                  <div className='border-b pb-4'>
                    <p className='text-slate-700 text-xl font-semibold font-header text-center'>
                      Popular Courses
                    </p>
                  </div>
                </div>
