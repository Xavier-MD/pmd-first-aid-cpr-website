  ...
  return (
    <a
      ...
      className={classNames(
        ...
        'inline-flex py-2 px-4 rounded font-header text-md shadow-md active:bg-blue-700 transition ease-in-out hover:-translate-y-[1px] hover:scale-110 duration-200'
      )}
    >
      {tabInfo.name}
    </a>
