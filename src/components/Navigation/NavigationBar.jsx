...
const NavigationBar = function () {
  ...
  return (
    <nav className='w-full h-auto fixed z-20'>
      <div className='h-[85px] px-8 xl:px-20 bg-gradient-to-b from-blue-400 via-blue-200 to-blue-50 shadow-md shadow-slate-300'>
        {/* Mobile menu button */}
        ...
        <div className='w-full h-full flex justify-center lg:justify-between'>
          ...
          <div className='mt-2 -mb-[47px] flex justify-center'>
            <div className='mx-2 p-3 bg-gradient-to-b from-blue-300 to-white border-[3px] border-slate-200 rounded-full shadow-md shadow-slate-300'>
              <HomeButton />
            </div>
          </div>
