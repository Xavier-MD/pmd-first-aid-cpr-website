...
import TabIcon from '../components/common/Navbar/TabIcon';
import MobileTab from '../components/common/Navbar/MobileTab';
...
const Navbar = function ({ currentTab, setCurrentTab, setCourse }) {
  return (
    <Disclosure
      as='nav'
